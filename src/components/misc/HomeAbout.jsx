                        ...
                        <div className="col-10 mx-auto text-md-right text-center">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3 col-12 pl-md-3 pt-md-3 mt-md-3 pt-2">
                                    <img className="about-img" src={ process.env.PUBLIC_URL + '/images/about/friendship.png'} 
                                            alt="About Friendship"/>

                                </div>
                                <div className="col-md-3 col-12 pt-2 ">
                                    <img className="about-img" src={ process.env.PUBLIC_URL + '/images/about/crossfit.png'} 
                                            alt="About CrossFit"/>
                            ...
                            <div className="row align-items-end">
                                <div className="col-md-5 pl-md-2 pt-md-2 col-12 mt-2">
                                    <img className="about-img" src={ process.env.PUBLIC_URL + '/images/about/felix.png'} 
                                            alt="About Felix"/>
